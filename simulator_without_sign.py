...
x,y,z=psi*np.sin(Theta)*np.cos(Phi),psi*np.sin(Theta)*np.sin(Phi),psi*np.cos(Theta)
...
ax.plot_surface(x, y, z, cmap='plasma', linewidth=0, alpha=0.7)
ax.grid(True)
ax.axis(True)
